...
(function() {
    ...
    */
    .factory( 'Facets', function( $rootScope, $q, SparqlService, facetMapperService, facetSelectionFormatter ) {
    ...
    */
    .directive('facetSelector', function() {
        return {
            restrict: 'E',
            scope: {
                endpointUrl: '=',
        ...
        */
        function FacetListCtrl ( $scope, _, Facets ) {
            var vm = this;
